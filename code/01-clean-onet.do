...
import excel "${raw}/onet/Task Statements.xlsx", firstrow clear                ;
...
distinct soc                                                                   ;
di as result "Core tasks: `=_N' across `r(ndistinct)' occupations"             ;
...
import excel "${raw}/onet/Occupation Data.xlsx", firstrow clear                ;
...
import excel "${raw}/onet/Alternate Titles.xlsx", firstrow clear               ;

rename ONETSOCCode soc                                                         ;
rename AlternateTitle alt_title                                                ;
keep soc alt_title                                                             ;

* Collapse into pipe-delimited string per SOC
sort soc alt_title                                                             ;
by soc : gen n = _n                                                            ;
